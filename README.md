HelloWorld. C# Tutorials. DotNet Framework Platform. Simple Input/Output. Windows Forms. GUI Application. 
...
HelloWorld. Занятия по C# Платформа DotNet Framework. Простой Ввод/ввывод. Windows Forms. Приложение с графическим интерфейсом пользователя.
